...
class HostProfileScreen extends StatefulWidget {
  ...
  var uID;
  HostProfileScreen(this.uID);
  @override
  _HostProfileScreenState createState() => _HostProfileScreenState();
}
                      ...
                      return ListView(
                        children: <Widget>[
                          ...
                          Column(children: <Widget>[
                            ...
                            uInfo["allGames"] == null || uInfo["allGames"] == []
                                ? SizedBox()
                                : Container(
                                    height: 70.h,
                                    child: ListView.builder(
                                        ...
                                        itemCount: uInfo["allGames"].length,
                                        itemBuilder: (ctx, ind) {
                                          return Card(
                                              elevation: 2,
                            ...
                            isMe
                                ? IconButton(
                                    ...
                                    onPressed: () {
                                      _showDropEdit1Dialog("Primary Game",
                                          "primaryGame", uInfo["primaryGame"]);
                                    })
                                : SizedBox()
                          ]),
                          SizedBox(
