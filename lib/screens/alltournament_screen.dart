...
class AllTournamentScreen extends StatefulWidget {
  static const routeName = '/alltournaments';
  var gameName;
  AllTournamentScreen(this.gameName);
  @override
  _AllTournamentScreenState createState() => _AllTournamentScreenState();
}
...
class _AllTournamentScreenState extends State<AllTournamentScreen> {
  ...
  void initState() {
    ...
    tournamentInfo.getBy = "game";
    tournamentInfo.game = widget.gameName;
